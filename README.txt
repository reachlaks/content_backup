...
\paperw11900\paperh16840\margl1440\margr1440\vieww25100\viewh13260\viewkind0
\deftab720
\pard\pardeftab720

\f0\fs24 \cf2 \expnd0\expndtw0\kerning0
\outl0\strokewidth0 \strokec2 %% readme.txt\
%% for content_backup (version 1.0)\
\
...
\outl0\strokewidth0 In Unix/Linux one way of running content_backup is to type the following at the command-line (options are shown in square brackets).\cf2 \expnd0\expndtw0\kerning0
\outl0\strokewidth0 \strokec2 \
\pard\pardeftab720
\cf2 \
Syntax:\
   sh content_backup.sh \cf0 \expnd0\expndtw0\kerning0
\outl0\strokewidth0 [-u] [-p] [-z] [-v] [-d] [-g] [-f]\cf2 \expnd0\expndtw0\kerning0
\outl0\strokewidth0 \strokec2 \
\
Options:\
...
\
However, even if we don\'92t mention any of the above parameters it will pick a default value for all of the parameters and run the script.\
\
(7) LICENSE (LPPL):\
-------------\
